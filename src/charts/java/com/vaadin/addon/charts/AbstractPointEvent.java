...
public abstract class AbstractPointEvent extends com.vaadin.ui.Component.Event {
    ...
    private int dataGroupStart;

    public AbstractPointEvent(Chart source, Series series, String category,
                              int pointIndex, int dataGroupStart, int dataGroupLength) {
        super(source);
        this.series = series;
        this.category = category;
        this.pointIndex = pointIndex;
        this.dataGroupLength = dataGroupLength;
        this.dataGroupStart = dataGroupStart;
    }
    ...
    public int getDataGroupStart() {
        return dataGroupStart;
    }
}
