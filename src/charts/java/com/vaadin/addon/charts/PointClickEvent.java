...
public class PointClickEvent extends AbstractPointEvent {
    ...
    public PointClickEvent(Chart source, MouseEventDetails details,
                           Series series, String category, int pointIndex, int dataGroupStart, int dataGroupLength) {
        super(source, series, category, pointIndex, dataGroupStart, dataGroupLength);
